...
stdout_path "#{wd}log/biodiv_staging_unicorn.stdout.log"

listen "#{wd}tmp/sockets/biodiv_staging_unicorn.sock"
worker_processes 1
timeout 30
...
before_fork do |server, worker|
  ...
  # old_pid = "/tmp/pids/biodiv_staging_unicorn.pid.oldbin"
